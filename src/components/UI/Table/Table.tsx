...
const EnhancedTableToolbar = (props: EnhancedTableToolbarProps) => {
  ...
  const { numSelected, handleAlertDeletion, selectedItems, defaultRowText } = props;
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete">
          <IconButton
            aria-label="delete"
            onClick={event => handleAlertDeletion(event, selectedItems)}
          >
            <DeleteIcon />
          </IconButton>
        </Tooltip>
  ...
  return (
    <div className={classes.root}>
      {/* <EnhancedTableToolbar
        ...
        handleAlertDeletion={(event, selectedItems) =>
          handleAlertDeletion(event, selectedItems)
        }
